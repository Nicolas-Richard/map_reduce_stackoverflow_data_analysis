...
public class WikipediaCounts {
    ...
    public static Boolean checkURLIsInCache(String text,
        ...
        if (set.contains(text)) {
            ...
            context.getCounter(counter_group, "Cache_Hits").increment(1);
            return true;
        }
        return false;
    }
    ...
    public static Boolean checkURLIsReachable(String result,
        ...
        try {
            ...
            context.getCounter(counter_group, statusCode.toString()).increment(1);
    ...
    public static String getWikipediaURL(String text,
                                         org.apache.hadoop.mapreduce.Mapper.Context context,
                                         String counter_group, Set<String> set) {
        ...
        if (idx == -1) {
            ...
            context.getCounter(counter_group, "Wikipedia_URL_Found").increment(1);
        }
        ...
        for (String URLToTest : URLsToTest) {
            if (checkURLIsInCache(URLToTest, set, context, counter_group)) {
                return URLToTest;
            }
        }
        ...
        for (String URLToTest : URLsToTest) {
            if (checkURLIsReachable(URLToTest, context, counter_group)) {
                return URLToTest;
            }
        }
        System.out.println("[!] URL processing failed :\t" + result);
        return null;
    }
    ...
    public static class SOWikipediaExtractor extends
        ...
        public static final String COUNTER_GROUP_NAME = "Counters";
        private final static IntWritable one = new IntWritable(1);
        private Set knownValidURLs = new HashSet();
        ...
        public void map(Object key, Text value, Context context)
            ...
            String url = getWikipediaURL(txt, context, COUNTER_GROUP_NAME, knownValidURLs);
            if (url == null) {
                return;
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "StackOverflow Wikipedia URL Count");
